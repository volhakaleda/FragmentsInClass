    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction.replace(R.id.main_container, fragment3).addToBackStack(MAIN_FRAGMENT_KEY);
                fragmentTransaction.commit();
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction.replace(R.id.main_container, fragment4).addToBackStack(MAIN_FRAGMENT_KEY);
                fragmentTransaction.commit();
            }
        });
        ...
        button5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction.replace(R.id.main_container, fragment5).addToBackStack(MAIN_FRAGMENT_KEY);
                fragmentTransaction.commit();
            }
        });
        return rootView;
